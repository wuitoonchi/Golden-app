...
@Component({
  ...
  templateUrl: './leaderships.page.html',
  styleUrls: ['./leaderships.page.scss'],
})
export class LeadershipsPage implements OnInit {
  ...
  ionViewWillEnter() {
    ...
    this.api.httpGetToken('shop/leaderships').then((res)=> {
