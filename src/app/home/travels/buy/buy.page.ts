import { CoinpaymentCreateTransactionComponent } from './../../../components/coinpayment-create-transaction/coinpayment-create-transaction.component';
...
export class BuyPage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.storageService.getItem('resume-account').subscribe((res)=> {
      ...
      this.dataResumeAccount.iq!=null? this.currentPrice = this.itemData.price_referral : this.currentPrice = this.itemData.price;
    });
  }
